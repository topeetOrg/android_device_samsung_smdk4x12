...
//xujie, USE_DAPM_VOICE = 0, do not use DAPM for voice call
//xujie, USE_DAPM_VOICE = 1, use DAPM for voice call
#define USE_DAPM_VOICE	0
...
//modem -> spk
    {"AIF2DACL Source", 0},		//use left channel
    {"AIF2DACR Source", 0},		//use left channel
    {"AIF2DAC Mux", 0},
...
//modem -> spk gain
    ...
    {"DAC1 Volume", 96},		//DAC1 Volume, 0dB
    {"DAC1 Switch", 1},			//DAC1 Switch, unmute
    {"AIF2DAC Volume", 96},		//AIF2DAC1 Input Volume, 0dB
//main mic -> modem
    {"AIF2ADC Mux", 0},
...
//modem -> hp
    ...
    {"DAC1L Mixer AIF2 Switch", 1},
    {"DAC1R Mixer AIF2 Switch", 1},
    {"Left Headphone Mux", 1},
    {"Right Headphone Mux", 1},
//modem -> hp gain
    {"AIF2DAC Volume", 96},
